...
print(
    "Setup complete \nOpened file "
    + str(sys.argv[1]) 
    + "  \nConverting to .root format and outputing to " 
    + output_file_name
)
...
polarization_v = r.vector("Double_t")()
...
output_tree.Branch("polarization", polarization_v)
    ...
    if in_ev == 1:
        ...
        try:
            if line.split()[1] == "1":
                ...
                polarization_v.push_back(float(line.split()[-1]))
