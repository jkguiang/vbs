...
int main(int argc, char** argv) 
{
    ...
    cutflow.insert(findleps, exactly1tightlep_postskim, Right);
    ...
    // Book hists
    for (auto cut : {WpWm_vs_WmWp, exactly1tightlep_postskim, geq1fatjet_postskim, STgt800_postskim})
    {
        for (auto hist : hists)
        {
