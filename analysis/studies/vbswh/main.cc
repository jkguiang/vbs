...
int main(int argc, char** argv) 
{
    ...
    JetEnergySFs* jet_sfs = new JetEnergySFs(cli.variation);
    LeptonSFsTTH* lep_sfs = new LeptonSFsTTH();
    ...
    // Lepton selection
    Cut* select_leps = new Core::SelectLeptons("SelectLeptons", analysis, lep_sfs);
    ...
    // Jet selection
    Cut* select_jets = new VBSWH::SelectJetsNoHbbOverlap("SelectJetsNoHbbOverlap", analysis, jet_sfs);
